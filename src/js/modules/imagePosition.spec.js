...
test('mouse move', () => {
  ...
  mockMouseEnter.cb({ preventDefault: () => {}, target: image, pageX: 10, pageY: 10 })
...
test('touch move', () => {
  ...
  mockTouchStart.cb({ preventDefault: () => {}, target: image, pageX: 10, pageY: 10 })
...
test('if element is not image is not moving', () => {
  ...
  mockTouchStart.cb({ preventDefault: () => {}, target: noImage, pageX: 10, pageY: 10 })
